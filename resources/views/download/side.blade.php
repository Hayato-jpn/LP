...
@section('content')
    ...
    <div class="ranking">
        ...
        <div class="ikukuru">
            <div class="box14">
                <p>登録人数1,300万人突破！</p>
                <p>約20年の運営実績を誇る老舗アプリ</p>
                <p>毎日2,000人を超えるユーザーが登録</p>
        ...
        <div class="moa">
            <div class="box14">
                <p>最高時給3,600円！</p>
                <p>LINE感覚でチャット・通話するだけ♬</p>
                <p>だから、好きな時間・場所でOK！</p>
                <p>今、巷で女性ユーザー急増中</p>
            </div>
            <p>ユーザー間のやり取りは専用アプリを使うので<br /><span>身バレの心配ありません！</span></p>
        ...
        <div class="charin">
            <div class="box14">
                <p>最高時給4,200円！</p>
                <p>SNS感覚で利用可能♬</p>
                <p>Twitter, instagram利用者にはピッタリ！</p>
                <p>新規サービスでユーザー募集中</p>
            </div>
            <p>専用アプリだけで<span>月10万円達成者「多数！」</span><br />手堅く稼ぎたいならコレ！</p>
